...
import { PreDefinedResponse, PromptProperties } from "../../QuestionForm.types";
import { Stack, Text } from "@chakra-ui/react";
import { DynamicText } from "components/DynamicText";

export const PromptFieldWrapper: FC<QuestionFieldRenderProps<PromptProperties>> = ({ question, onEndFormClickCallback }) => {
