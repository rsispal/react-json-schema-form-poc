...
import { PreDefinedResponse, WarningProperties } from "../../QuestionForm.types";
import { Stack, Text } from "@chakra-ui/react";
import { DynamicText } from "components/DynamicText";

export const WarningFieldWrapper: FC<QuestionFieldRenderProps<WarningProperties>> = ({ question, onEndFormClickCallback }) => {
