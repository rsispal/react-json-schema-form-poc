...
import { LinkButtonProperties, PreDefinedResponse } from "../../QuestionForm.types";
import { Stack, Text } from "@chakra-ui/react";
import { DynamicText } from "components/DynamicText";

export const LinkButtonFieldWrapper: FC<QuestionFieldRenderProps<LinkButtonProperties>> = ({
  question,
  ...
  return (
    <Stack>
      ...
      <LinkButton {...question.properties} onClickCallback={handleClick} dataTestId={`${question.name}-link-button`} />
    </Stack>
  );
};
